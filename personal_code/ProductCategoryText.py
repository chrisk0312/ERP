...
with open("C:\\study\\ERP\\SAP_bike_sales(datasets)\\ProductCategoryText.csv", 'r', encoding='utf-8') as file:
...
def chatbot():
    print("Hello!\nI am here to help you find sample of SAP product categoryTexts.\n"
          "Please enter the product category ID you wish to search for.\n"
