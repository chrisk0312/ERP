...
with open("C:\\study\\ERP\\SAP_bike_sales(datasets)\\Products.csv", 'r', encoding='utf-8') as file:
...
def chatbot():
    print("Hello!\nI am here to help you find sample of SAP products.\n"
          "Please enter the product ID you wish to search for.\n"
