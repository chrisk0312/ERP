...
def chatbot():
    print("Hello!\nI am here to help you find sample of ProductTexts of SAP.\n"
          "Please enter the ProductTexts you wish to search for.\n"
          "ProductTexts category ID is a 5 digit number starting from 40001 to 40009."
          )
